...
params: 
  ...
  archivo:
    ...
    value: temperaturas.csv
    input: file
# rmarkdown::render("D:/Mastering-Shiny_Book-Club/flujo_de_trabajo/paso-3_reporte_parametrizado/reporte.Rmd", params = "ask")
---

```{r cargar-data, include = FALSE}
# Base de datos usada para crear el data frame "temperaturas":
# nottem (Average Monthly Temperatures at Nottingham, 1920-1939)
temperaturas <- read.csv(params$archivo)  
```
