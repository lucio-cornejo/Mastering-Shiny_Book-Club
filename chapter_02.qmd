...
- `textOutput()`, junto con `renderText({})`, se emplean para impprimir texto estándar 
...
como hemos estado haciendo para `fluidRow()`.
...
Resolvamos el ejercicio 4 de esta sección del capítulo.
